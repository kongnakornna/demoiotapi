    ...
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forFeature([
                user_entity_1.User, role_entity_1.Role, rolesaccess_entity_2.Rolesaccess, sduserrole_entity_1.SdUserRole, file_entity_1.UserFile, rolesaccess_entity_1.SdUserRolesAccess, userrolepermission_entity_1.UserRolePermission,
                setting_entity_1.Setting, location_entity_1.Location, type_entity_1.Type, sensor_entity_1.Sensor, group_entity_1.Group, mqtt_entity_1.Mqtt, api_entity_1.Api, device_entity_1.Device, devicetype_entity_1.DeviceType, email_entity_1.Email, host_entity_1.Host,
                influxdb_entity_1.Influxdb, line_entity_1.Line, nodered_entity_1.Nodered, schedule_entity_1.Schedule, sms_entity_1.Sms, token_entity_1.Token, deviceaction_entity_1.Deviceaction, deviceactionlog_entity_1.Deviceactionlog,
                deviceactionuser_entity_1.Deviceactionuser, devivicealarmaction_entity_1.Devicealarmaction, telegram_entity_1.Telegram, scheduledevice_entity_1.scheduleDevice, alarmdevice_entity_1.alarmDevice,
                alarmdeviceevent_entity_1.alarmDeviceEvent, scheduleprocesslog_entity_1.scheduleprocesslog, alarmprocesslog_entity_1.alarmprocesslog, alarmprocesslogtemp_entity_1.alarmprocesslogtemp,
                alarmprocesslogemail_entity_1.alarmprocesslogemail, alarmprocesslogline_entity_1.alarmprocesslogline, alarmprocesslogsms_entity_1.alarmprocesslogsms,
                alarmprocesslogtelegram_entity_1.alarmprocesslogtelegram, mqtthost_entity_1.mqtthost, alarmprocesslogmqtt_entity_1.alarmprocesslogmqtt,
                aircontrol_entity_1.aircontrol, airmod_entity_1.airmod, airperiod_entity_1.airperiod, airsettingwarning_entity_1.airsettingwarning, airwarning_entity_1.airwarning, aircontroldevicemap_entity_1.aircontroldevicemap,
                airmoddevicemap_entity_1.airmoddevicemap, airperioddevicemap_entity_1.airperioddevicemap, airsettingwarningdevicemap_entity_1.airsettingwarningdevicemap, airwarningdevicemap_entity_1.airwarningdevicemap,
                aircontrollog_entity_1.aircontrollog, mqttlog_entity_1.mqttlog, dashboard_config_entity_1.dashboardConfig
            ]),
        ...
        exports: [
            ...
            iot_service_1.IotService,
            typeorm_1.TypeOrmModule.forFeature([
                user_entity_1.User, role_entity_1.Role, mqtthost_entity_1.mqtthost, device_entity_1.Device, setting_entity_1.Setting
            ])
        ],
    })
], MqttModule);
