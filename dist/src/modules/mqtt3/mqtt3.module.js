...
const mqtt3_controller_1 = require("./mqtt3.controller");
...
let Mqtt3Module = class Mqtt3Module {
};
Mqtt3Module = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            microservices_1.ClientsModule.registerAsync([
                {
                    ...
                    useFactory: async () => {
                        return {
                            ...
                            options: {
                                url: process.env.MQTT_HOST3 || 'mqtt://172.25.99.10:1883',
        ...
        controllers: [mqtt3_controller_1.Mqtt3Controller],
        providers: [
...
exports.Mqtt3Module = Mqtt3Module;
//# sourceMappingURL=mqtt3.module.js.map