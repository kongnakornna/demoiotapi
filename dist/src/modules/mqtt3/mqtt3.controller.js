...
var Mqtt3Controller_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.Mqtt3Controller = void 0;
...
var connectUrl_mqtt = process.env.MQTT_HOST3 || 'mqtt://172.25.99.10:1883';
if (!connectUrl_mqtt) {
    var connectUrl_mqtt = process.env.MQTT_HOST || 'mqtt://localhost:1883';
}
const swagger_1 = require("@nestjs/swagger");
const mqtt3_service_1 = require("./mqtt3.service");
...
const caches = redis_helper_1.cacheDataOne;
...
let Mqtt3Controller = Mqtt3Controller_1 = class Mqtt3Controller {
    constructor(mqtt3Service, IotService, UsersService, settingsService) {
        this.mqtt3Service = mqtt3Service;
        this.IotService = IotService;
        this.UsersService = UsersService;
        this.settingsService = settingsService;
        this.logger = new common_1.Logger(Mqtt3Controller_1.name);
    }
    ...
    async checkConnectionIndex(res, dto, query, headers, req) {
        try {
            var checkConnectionMqtt = await this.mqtt3Service.checkConnectionStatusMqtt();
            if (checkConnectionMqtt) {
                ...
                if (Mqttstatus == 0) {
                    res.status(200).json({
                        ...
                        message: 'check Connection Status mqtt3',
                        message_th: 'check Connection Status mqtt3',
                    });
                    return;
                }
            }
    ...
    async topic(res, dto, query, headers, req) {
        try {
            ...
            var mqttdata = await this.mqtt3Service.getdMqttdataTopics(topic);
            res.status(200).json({
                statuscode: 200,
                code: 200,
                Mqttstatus,
    ...
    async device_control_data(res, dto, query, headers, params, req) {
        ...
        var data = await this.mqtt3Service.devicecontrol(topic_send, message_send);
    ...
    async devicebuckets(res, dto, query, headers, params, req) {
        ...
        try {
            const checkConnectionMqtt = await this.mqtt3Service.checkConnectionStatusMqtt();
            if (checkConnectionMqtt) {
            ...
            if (device && device_count > 0) {
                ...
                const mqttdata = await this.mqtt3Service.getdMqttdataTopics(topic);
                let mqttdata_arrs;
    ...
    async sensercharts(res, query, headers, params, req) {
        ...
        var kaycache1 = 'mqtt3_get_start_to_end_v1_' +
            md5(start +
                stop +
                windowPeriod +
                tzString +
        ...
        console.info(Dtos2);
        var kaycache2 = 'mqtt3_get_start_to_end_v2_' +
            md5(start +
                stop +
                windowPeriod +
                tzString +
        ...
        var kaycache3 = 'mqtt3_get_start_to_end_v3_' +
            md5(start +
                stop +
                windowPeriod +
                tzString +
    ...
    async alarmdevicestatus(res, query, headers, params, req) {
        ...
        try {
            ...
            if (rowResultData) {
                ...
                var rowResultData = await this.mqtt3Service.alarm_device_paginate_status(filter);
                var row = rowResultData;
                var rowResultData = {
            ...
            if (ResultData) {
                ...
                var ResultData = await this.mqtt3Service.alarm_device_paginate_status(filter2);
                var rs = {
                    keycache: `${kaycache_cache}`,
                    time: cachetimeset,
                    data: ResultData,
            ...
            for (const [key, va] of Object.entries(ResultData)) {
                ...
                if (alarmdevice) {
                    for (const [key, value] of Object.entries(alarmdevice)) {
                        ...
                        var mqttrs = await this.mqtt3Service.getMqttTopicPA1(mqtt_data_value, deletecache);
    ...
    async monitordevicegroup(res, query, headers, params, req) {
        ...
        if (!ResultData) {
            var datacahe_status = 0;
            var ResultData = await this.mqtt3Service.devicetype(query);
            var filterSetCacheData = {};
            filterSetCacheData.keycache = cache_key;
            filterSetCacheData.time = 60 * 60 * 1;
        ...
        try {
            ...
            if (device && device_count > 0) {
                ...
                for (const [key, va] of Object.entries(device)) {
                    ...
                    var measurement = device[key].measurement;
                    var filterAlarmValidate = {};
                    filterAlarmValidate.type_id = device[key].hardware_id;
                    filterAlarmValidate.value_data = value_data;
                    ...
                    RSdata.sensercharts =
                        Url_api +
                            ...
                            '&measurement=' +
                            device[key].measurement;
                    RSdata.mqttdata = mqttdata;
                    RSdata.merged = merged;
                    RSdata.mqttData = mqttData;
                    deviceData.push(RSdata);
                }
    ...
    async mqtt_control_device(mqtt_data_control, messageMqttControls) {
        ...
        try {
            ...
            var devicecontrol = await this.mqtt3Service.devicecontrol(topic_sends, message_sends);
    ...
    async device_access_control_check(dto) {
        ...
        try {
            ...
            var MQTTGETDATA = await this.mqtt3Service.getdevicedataDirec(mqtt_data_value);
            if (MQTTGETDATA) {
                const mqttrs = await this.mqtt3Service.getdevicedataAll(mqtt_data_value);
    ...
    async device_access_email_new(dto) {
        try {
            ...
            const MQTTGETDATA = await this.mqtt3Service.getdevicedataDirec(mqtt_data_value);
            if (MQTTGETDATA) {
                const mqttrs = await this.mqtt3Service.getdevicedataAll(mqtt_data_value);
                const mqttData = mqttrs['data'];
        ...
        try {
            ...
            if (ResultData) {
                for (const [key, value] of Object.entries(ResultData)) {
                    ...
                    const mqttrs = await this.mqtt3Service.getMqttTopicDataRS(topic, deletecache);
    ...
    async scheduleproces(res, query, headers, params, req) {
        try {
            ...
            filter.isCount = 1;
            var rowResultData = await this.mqtt3Service.scheduleprocess(filter);
            if (rowResultData == '' ||
                !rowResultData ||
            ...
            var end_time = '';
            var do_ststus = '';
            var ResultData = await this.mqtt3Service.scheduleprocess(filter2);
            let tempData = [];
            let tempDataoid = [];
            let tempData2 = [];
            for (const [key, va] of Object.entries(ResultData)) {
                ...
                if (today_status == 1 && now_time_1 == now_time_2) {
                    if (now_time_1 == '1' && now_time_2 == '1') {
                        ...
                        var log_count = await this.mqtt3Service.scheduleprocesslog_count(dataset);
                        if (log_count >= 1) {
                            var log_count2 = await this.mqtt3Service.scheduleprocesslog_count_status(dataset);
                            if (log_count2 == 0) {
                                var deviceData = await this.mqtt3Service.getdevicedata(mqtt_data_value);
                                if (deviceData) {
                                    var devicecontrol = await this.mqtt3Service.devicecontrol(mqtt_data_control, message_mqtt_control);
                                    var now_time_s = timestamp;
                                    var datasetupdate = {
                                        schedule_id: schedule_id,
                                        device_id: device_id,
                                    ...
                                    await this.mqtt3Service.update_scheduleprocesslog_v2(datasetupdate);
                                }
                            }
                        }
                        else {
                            ...
                            if (log_count == 0) {
                                var devicecontrol = await this.mqtt3Service.devicecontrols(mqtt_data_control, message_mqtt_control, message_control);
                            }
                            var now_time_s = timestamp;
                            var deviceData = await this.mqtt3Service.getdevicedata(mqtt_data_value);
                            if (deviceData) {
...
], Mqtt3Controller.prototype, "handleDeviceStatus", null);
__decorate([
...
], Mqtt3Controller.prototype, "checkConnectionIndex", null);
__decorate([
    (0, common_1.HttpCode)(200),
    (0, common_1.Header)('Cache-Control', 'no-store'),
    ...
    __metadata("design:paramtypes", [Object, Object, Object, Object, Object]),
    __metadata("design:returntype", Promise)
], Mqtt3Controller.prototype, "checkConnection", null);
__decorate([
    (0, common_1.HttpCode)(200),
    (0, common_1.Header)('Cache-Control', 'no-store'),
    ...
    __metadata("design:paramtypes", [Object, Object, Object, Object, Object]),
    __metadata("design:returntype", Promise)
], Mqtt3Controller.prototype, "topic", null);
__decorate([
    (0, common_1.HttpCode)(200),
    (0, common_1.Header)('Cache-Control', 'no-store'),
    ...
    __metadata("design:returntype", Promise)
], Mqtt3Controller.prototype, "device_control_data", null);
__decorate([
    (0, common_1.HttpCode)(200),
    (0, common_1.Header)('Cache-Control', 'no-store'),
    ...
    __metadata("design:paramtypes", [Object, Object, Object, Object, Object, Object]),
    __metadata("design:returntype", Promise)
], Mqtt3Controller.prototype, "devicebuckets", null);
__decorate([
    (0, common_1.HttpCode)(200),
    (0, common_1.Header)('Cache-Control', 'no-store'),
    ...
    __metadata("design:paramtypes", [Object, Object, Object, Object, Object]),
    __metadata("design:returntype", Promise)
], Mqtt3Controller.prototype, "sensercharts", null);
__decorate([
    (0, common_1.HttpCode)(200),
    ...
    __metadata("design:paramtypes", [Object, Object, Object, Object, Object]),
    __metadata("design:returntype", Promise)
], Mqtt3Controller.prototype, "alarmdevicestatus", null);
__decorate([
    (0, common_1.HttpCode)(200),
    ...
    __metadata("design:paramtypes", [Object, Object, Object, Object, Object]),
    __metadata("design:returntype", Promise)
], Mqtt3Controller.prototype, "monitordevicegroup", null);
__decorate([
    (0, common_1.HttpCode)(200),
    ...
    __metadata("design:paramtypes", [Object, Object, Object, Object, Object]),
    __metadata("design:returntype", Promise)
], Mqtt3Controller.prototype, "scheduleproces", null);
Mqtt3Controller = Mqtt3Controller_1 = __decorate([
    (0, common_1.Controller)('mqtt3'),
    __metadata("design:paramtypes", [mqtt3_service_1.Mqtt3Service,
        iot_service_1.IotService,
        users_service_1.UsersService,
        settings_service_1.SettingsService])
], Mqtt3Controller);
exports.Mqtt3Controller = Mqtt3Controller;
//# sourceMappingURL=mqtt3.controller.js.map